...
const PAUSE_TIME = 800; // Waktu jeda setelah selesai mengetik/menghapus (ms)
...
const Hero = () => {
    ...
    return (
        <section id="hero" className="mt-20 flex flex-col justify-center items-center text-center p-4">
            ...
            <h1 className="text-5xl md:text-4xl my-2 text-white drop-shadow-lg">
                Hai, My Name is <span className='font-bold'>Reffa Hibatullah</span>
            </h1>
            <p className="text-xl md:text-3xl text-white drop-shadow-lg mt-2">
                I am a <span className="font-bold text-yellow-300">{currentText}</span><span className="typing-cursor"></span>
            </p>
        </section>
    );
};
